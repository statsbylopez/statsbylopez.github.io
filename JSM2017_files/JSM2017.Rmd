...
1. Equality at a fixed time (variability of $\theta_{(q,s,k) i}$'s)
2. Within season equality ($\gamma_{q, week}$)
3. Between season equality ($\gamma_{q, season}$)
...
## NFL's parity: equivalence of teams at fixed point in time
...
## NFL's parity: evolution of strength over time
